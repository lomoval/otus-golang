...
func TestIncorrectData(t *testing.T) {
	t.Run("empty email", func(t *testing.T) {
		data := `{"Id":2,"Name":"Jesse Vasquez","Username":"qRichardson","Email":"","Phone":"9-373-949-64-00","Password":"SiZLeNSGn","Address":"Fulton Hill 80"}`
		result, err := GetDomainStat(bytes.NewBufferString(data), "com")
		require.NoError(t, err)
		require.Equal(t, DomainStat{}, result)
	})
	...
	t.Run("incorrect email", func(t *testing.T) {
		data := `{"Id":2,"Name":"Jesse Vasquez","Username":"qRichardson","Email":"incorrect<dog>email.com","Phone":"9-373-949-64-00","Password":"SiZLeNSGn","Address":"Fulton Hill 80"}`
		result, err := GetDomainStat(bytes.NewBufferString(data), "com")
		require.Error(t, err)
